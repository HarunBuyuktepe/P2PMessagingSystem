...
//                // System.out.println("Sertifika uzunlu�u " + client.serverCertificate.length);
...
//
//    // Constructor
//    public PeerUserOneHandler(Socket s, ObjectInputStream objectInputStream, ObjectOutputStream objectOutputStream, Client1 client) {
//        this.s = s;
